export class FuseUtils
{
    ...
    public static filterFieldsByString(mainArr, searchText, fields)
    {
        if ( searchText === '' )
        {
            return mainArr;
        ...
        return mainArr.filter(itemObj => {
            return this.searchFieldsInObj(itemObj, searchText, fields);
        });
    }
    ...
    public static searchFieldsInObj(itemObj, searchText, fields)
    {
    ...
    public static convertUcfirst(string)
    {
