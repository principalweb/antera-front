...
import { PromoShipmapComponent } from 'app/features/admin/connectors/promo/promo-shipmap/promo-shipmap.component';
...
export class PromoComponent implements OnInit, OnDestroy {
    ...
    dialogRef: MatDialogRef<PromoShipmapComponent>;
    ...
    showCompanyDetail(company) {
        this.dialogRef = this.dialog.open(PromoShipmapComponent, {
