...
export class RecevingComponent implements OnInit {

  @Input() widgets: any;
  @Input() widgetRecevingData: any;
  ...
  ngOnInit() {
    ...
    this.dataSource1 = new MatTableDataSource(this.salesRepTopData);
