...
@Component({
    selector   : 'antera-credit-memo-modern',
    templateUrl: './credit-memo-modern.component.html',
    styleUrls  : ['./credit-memo-modern.component.scss'],
    animations : fuseAnimations
})
export class AnteraCreditMemoModernComponent
{
    @Input() order: any;
